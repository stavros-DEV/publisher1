...
public class PublishNewsItemService extends HttpServlet
{
			...
			throws ServletException, IOException
	{
		...
		{
			/*This operation relies on extracting data from an underlying communications socket, which 
			 * may fail if there is a network or other communications error. The build operation may also
			 * fail if the incoming characters can not be parsed as an XML document.*/
		...
		logger.debug("Publisher XML Built success:"+responseDocumentString);
